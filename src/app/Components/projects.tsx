...
const ProjectsSection = () => {
  return (
    <div className="max-w-6xl mx-auto p-8" id="project">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 m-8 gap-6 w-full mx-auto">
        <div className="h-auto bg-gray-100 p-6 shadow-md rounded-lg flex flex-col justify-between hover:bg-orange-500 hover:text-white">
          ...
          <Link
            href="https://www.npmjs.com/package/@khansakhalid/calculator"
            target="_blank"
          >
        ...
        <div className="h-auto bg-gray-100 p-6 shadow-md rounded-lg flex flex-col justify-between hover:bg-orange-500 hover:text-white">
          ...
          <Link
            href="https://www.npmjs.com/package/@khansakhalid/guess-number"
            target="_blank"
          >
        ...
        <div className="h-auto bg-gray-100 p-6 shadow-md rounded-lg flex flex-col justify-between hover:bg-orange-500 hover:text-white">
          ...
          <Link
            href="https://www.npmjs.com/package/@khansakhalid/atmsystem"
            target="_blank"
          >
            <span className="text-blue-600 mt-4 mx-auto block">
              View Project
